...
func TestUptimeMonitorsDataSource_Metadata(t *testing.T) {
	d := NewUptimeMonitorsDataSource()
	...
	require.Equal(t, "phare_uptime_monitors", resp.TypeName)
}

func TestUptimeMonitorsDataSource_Schema(t *testing.T) {
	d := NewUptimeMonitorsDataSource()
...
func TestUptimeMonitorsDataSource_Configure(t *testing.T) {
	// Create a real client for testing
	realClient := &client.Client{}

	d := &uptimeMonitorsDataSource{}
