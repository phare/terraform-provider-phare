...
- `phare_uptime_status_page` resource and data sources now support the `show_response_times` parameter
- `phare_uptime_status_page` resource and data sources now support the `display_name` parameter for monitor components
...
- `phare_uptime_monitor_http` and `phare_uptime_monitor_tcp` can now be imported with `terraform import`.

## [0.0.12] - 2026-07-31

### Added

- `phare_uptime_status_page` now supports the `uptime/group` component type.

## [0.0.11] - 2026-07-27

### Fixed

- Improve multi-part form parsing logic to preserve status page components ordering 

## [0.0.10] - 2026-05-31

### Changed

- Updated the `phare_uptime_status_page` resource default document theme with new values

## [0.0.9] - 2026-05-17

### Added

- `phare_uptime_status_page` now supports the `access_ips`, `access_token` and `access_password` parameters
